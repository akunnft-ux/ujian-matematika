...
insert into public.soal_bank (id, mapel, jenjang, topik, kode, blocks, opsi, kunci, pembahasan, status, uploader)
values
  ('S-001', 'Matematika', 'SMA', 'Kalkulus', 'M-2026-001',
   ...
   'aktif', 'guru'),
  ('S-002', 'Matematika', 'SMA', 'Integral', 'M-2026-001',
